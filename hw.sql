...
GetEmployeeOrders @employeeID=4

/* 2.Создайте таблицу EmployeeRoles, как на уроке и удалите ее.*/

CREATE TABLE IF NOT EXISTS EmployeeRoles (EmployeeRoleID INT PRIMARY KEY, EmployeeID INT, Role VARCHAR(50));
